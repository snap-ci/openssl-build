...
Source13: ectest.c
# Build changes
Patch1: openssl-1.0.1t-rpmbuild.patch
Patch2: openssl-1.0.1t-makefile-rpmbuild.patch
Patch3: openssl-1.0.0f-defaults.patch
Patch4: openssl-1.0.0-beta5-enginesdir.patch
Patch5: openssl-0.9.8a-no-rpath.patch
Patch6: openssl-1.0.1t-test-use-localhost.patch
Patch7: openssl-1.0.0-timezone.patch
Patch8: openssl-1.0.1c-perlfind.patch
Patch9: openssl-1.0.1c-aliasing.patch
Patch10: openssl-1.0.1t-update-expired-smime-test-certs.patch
...
* Fri Dec  4 2015 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-43
...
* Tue Jun  9 2015 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-40
...
* Tue Jun  2 2015 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-39
- fix CVE-2015-3216 - regression in RAND locking that can cause segfaults on
  read in multithreaded applications

* Mon May 25 2015 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-38
- fix CVE-2015-4000 - prevent the logjam attack on client - restrict
  the DH key size to at least 768 bits (limit will be increased in future)

* Wed Mar 25 2015 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-37
- drop the AES-GCM restriction of 2^32 operations because the IV is
  always 96 bits (32 bit fixed field + 64 bit invocation field)

* Thu Mar 19 2015 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-36
- update fix for CVE-2015-0287 to what was released upstream

* Wed Mar 18 2015 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-35
...
* Tue Mar  3 2015 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-34
...
* Tue Jan 13 2015 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-33
...
* Thu Oct 16 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-32
- use FIPS approved method for computation of d in RSA

* Wed Oct 15 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-31
- fix CVE-2014-3567 - memory leak when handling session tickets
- fix CVE-2014-3513 - memory leak in srtp support
- add support for fallback SCSV to partially mitigate CVE-2014-3566
  (padding attack on SSL3)

* Fri Aug 15 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-30
- add ECC TLS extensions to DTLS (#1119800)

* Fri Aug  8 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-29
...
* Mon Jun 16 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-28
- fix CVE-2014-0224 fix that broke EAP-FAST session resumption support

* Fri Jun  6 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-26
...
* Mon Jun  2 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-25
...
* Thu May 22 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-24
- add back support for secp521r1 EC curve

* Mon Apr  7 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-23
- fix CVE-2014-0160 - information disclosure in TLS heartbeat extension

* Mon Mar 17 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-22
- use 2048 bit RSA key in FIPS selftests

* Wed Feb 19 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-21
...
* Tue Jan  7 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-20
- fix CVE-2013-4353 - Invalid TLS handshake crash

* Mon Jan  6 2014 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-19
- fix CVE-2013-6450 - possible MiTM attack on DTLS1

* Fri Dec 20 2013 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-18
- fix CVE-2013-6449 - crash when version in SSL structure is incorrect

* Thu Dec 12 2013 Tomáš Mráz <tmraz@redhat.com> 1.0.1e-17
